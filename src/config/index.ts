...
const envSchema = z.object({
  ...
  JWT_SECRET: z.string(),
  JWT_ACCESS_EXPIRATION_MINUTES: z.number().default(60),
  JWT_REFRESH_EXPIRATION_DAYS: z.number().default(15),
  JWT_RESET_PASSWORD_EXPIRATION_MINUTES: z.number().default(20),
